    ...
    private JButton[] createButtons() {
        ...
        switch(_optionType) {
            case YES_NO_OPTION:
                ...
                buttons = new JButton[] { _yesButton, _noButton };
                break;
            ...
            case YES_NO_HELP_OPTION:
                ...
                buttons = new JButton[] { _yesButton, _noButton, _helpButton };
                break;
            ...
            case YES_NO_CANCEL_OPTION:
                ...
                buttons = new JButton[] { _yesButton, _noButton, _cancelButton };
                break;
            ...
            case YES_NO_CANCEL_HELP_OPTION:
                ...
                _cancelButton = new JButton();
                _helpButton = new JButton();
                buttons = new JButton[] { _yesButton, _noButton, _cancelButton, _helpButton };
                break;
        
            case OK_CANCEL_OPTION:
                _okButton = new JButton();
                _cancelButton = new JButton();
                buttons = new JButton[] { _okButton, _cancelButton };
                break;
            ...
            case OK_CANCEL_HELP_OPTION:
                ...
                _cancelButton = new JButton();
                _helpButton = new JButton();
                buttons = new JButton[] { _okButton, _cancelButton, _helpButton };
                break;

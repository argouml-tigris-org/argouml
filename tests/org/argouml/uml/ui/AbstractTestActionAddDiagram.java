...
public abstract class AbstractTestActionAddDiagram extends TestCase {
	...
	public void testCreateDiagram() {
        ...
        assertTrue("The diagram has a non-valid namespace", _action.isValidNamespace(diagram.getNamespace()));
	...
	public void testValidTestNamespace() {
		assertTrue("The namespace with this testis not valid for this diagram", _action.isValidNamespace(_ns));
	}
	...
	public void testValidNamespaces() {
		...
		while (it.hasNext()) {
			...
			try {
				...
				assertTrue(clazz.getName() + " is no valid namespace for the diagram", _action.isValidNamespace((MNamespace)o));
			}
			catch (Exception ex) {
				fail(ex.getMessage());
			}

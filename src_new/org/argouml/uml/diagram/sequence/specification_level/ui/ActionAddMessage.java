...
public class ActionAddMessage extends CmdSetMode {

    public ActionAddMessage(UMLSequenceDiagram diagram, Class actionClass, String name) {
        super(ModeCreateMessage.class, "edgeClass", actionClass, "Message" + name);
        putValue(Action.NAME, name);
        _modeArgs.put("diagram", diagram);

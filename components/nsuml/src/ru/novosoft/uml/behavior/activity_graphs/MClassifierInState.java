...
public interface MClassifierInState extends MClassifier
{
  ...
  void setInStates(Collection __arg);
  void addInState(MState __arg);
  void removeInState(MState __arg);
  void internalRefByInState(MState __arg);
  void internalUnrefByInState(MState __arg);
}

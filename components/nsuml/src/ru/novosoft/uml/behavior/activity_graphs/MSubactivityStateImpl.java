...
{
  // ------------ code for class SubactivityState -----------------
  // generating attributes
  // attribute: dynamicMultiplicity
  private final static Method _dynamicMultiplicity_setMethod = getMethod1(MSubactivityStateImpl.class, "setDynamicMultiplicity", MMultiplicity.class);
  ...
  private final static Method _dynamicArguments_setMethod = getMethod1(MSubactivityStateImpl.class, "setDynamicArguments", MArgListsExpression.class);
  ...
  // attribute: isDynamic
  private final static Method _isDynamic_setMethod = getMethod1(MSubactivityStateImpl.class, "setDynamic", boolean.class);
  boolean _isDynamic;

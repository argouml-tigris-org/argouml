...
public class MSendActionImpl extends MActionImpl implements MSendAction
{
  // ------------ code for class SendAction -----------------
  // generating attributes
  // generating associations
  // opposite role: signal this role: sendAction
  private final static Method _signal_setMethod = getMethod1(MSendActionImpl.class, "setSignal", MSignal.class);
  MSignal _signal;
  ...
  public final void setSignal(MSignal __arg)
  {
    ...
    try
    {
      ...
      if (_signal != __arg)
      {
        if (__saved != null)
        {
          __saved.internalUnrefBySendAction(this);
        }
        if (__arg != null)
        {
          __arg.internalRefBySendAction(this);
        }

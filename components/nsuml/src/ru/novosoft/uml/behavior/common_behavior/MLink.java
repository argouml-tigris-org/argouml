...
public interface MLink extends MModelElement
{
  ...
  void setConnections(Collection __arg);
  void addConnection(MLinkEnd __arg);
  void removeConnection(MLinkEnd __arg);
  void internalRefByConnection(MLinkEnd __arg);
  void internalUnrefByConnection(MLinkEnd __arg);

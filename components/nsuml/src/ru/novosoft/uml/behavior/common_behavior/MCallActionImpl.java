...
{
  // ------------ code for class CallAction -----------------
  // generating attributes
  // generating associations
  // opposite role: operation this role: callAction
  private final static Method _operation_setMethod = getMethod1(MCallActionImpl.class, "setOperation", MOperation.class);
  ...
  public final void setOperation(MOperation __arg)
  {
    ...
    try
    {
      ...
      if (_operation != __arg)
      {
        if (__saved != null)
        {
          __saved.internalUnrefByCallAction(this);
        }
        if (__arg != null)
        {
          __arg.internalRefByCallAction(this);
        }
  ...
  public final void internalRefByOperation(MOperation __arg)
  {
    ...
    if (_operation != null)
    {
      _operation.removeCallAction(this);
    }
    fireRefSet("operation", __saved, __arg);
    _operation = __arg;
  }

...
{
  // ------------ code for class NodeInstance -----------------
  // generating attributes
  // generating associations
  // opposite role: resident this role: nodeInstance
  private final static Method _resident_setMethod = getMethod1(MNodeInstanceImpl.class, "setResidents", Collection.class);
  private final static Method _resident_addMethod = getMethod1(MNodeInstanceImpl.class, "addResident", MComponentInstance.class);
  private final static Method _resident_removeMethod = getMethod1(MNodeInstanceImpl.class, "removeResident", MComponentInstance.class);
  ...
  public final void setResidents(Collection __arg)
  {
    ...
    try
    {
      ...
      while (iter1.hasNext())
      {
        MComponentInstance o = (MComponentInstance)iter1.next();
        o.internalUnrefByNodeInstance(this);
      }
      Iterator iter2 = __added.iterator();
      while (iter2.hasNext())
      {
        MComponentInstance o = (MComponentInstance)iter2.next();
        o.internalRefByNodeInstance(this);
      }
  ...
  public final void addResident(MComponentInstance __arg)
  {
    operationStarted();
    try
    {
      ...
      __arg.internalRefByNodeInstance(this);
      _resident.add(__arg);
  ...
  public final void removeResident(MComponentInstance __arg)
  {
    operationStarted();
    try
    {
      ...
      __arg.internalUnrefByNodeInstance(this);
  ...
  public final void internalRefByResident(MComponentInstance __arg)
  {
    final boolean sendEvent = needEvent();
    Collection old = null;
    if (sendEvent)
  ...
  public final void internalUnrefByResident(MComponentInstance __arg)
  {
    final boolean sendEvent = needEvent();
    Collection old = null;
    if (sendEvent)

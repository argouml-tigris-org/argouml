...
public class MLinkObjectImpl extends MLinkImpl implements MLinkObject
{
  // ------------ code for class Instance -----------------
  // generating attributes
  // generating associations
  // opposite role: stimulus2 this role: receiver
  private final static Method _stimulus2_setMethod = getMethod1(MLinkObjectImpl.class, "setStimuli2", Collection.class);
  private final static Method _stimulus2_addMethod = getMethod1(MLinkObjectImpl.class, "addStimulus2", MStimulus.class);
  private final static Method _stimulus2_removeMethod = getMethod1(MLinkObjectImpl.class, "removeStimulus2", MStimulus.class);
  ...
  private final static Method _componentInstance_setMethod = getMethod1(MLinkObjectImpl.class, "setComponentInstance", MComponentInstance.class);
  ...
  private final static Method _stimulus3_setMethod = getMethod1(MLinkObjectImpl.class, "setStimuli3", Collection.class);
  private final static Method _stimulus3_addMethod = getMethod1(MLinkObjectImpl.class, "addStimulus3", MStimulus.class);
  private final static Method _stimulus3_removeMethod = getMethod1(MLinkObjectImpl.class, "removeStimulus3", MStimulus.class);
  ...
  private final static Method _stimulus1_setMethod = getMethod1(MLinkObjectImpl.class, "setStimuli1", Collection.class);
  private final static Method _stimulus1_addMethod = getMethod1(MLinkObjectImpl.class, "addStimulus1", MStimulus.class);
  private final static Method _stimulus1_removeMethod = getMethod1(MLinkObjectImpl.class, "removeStimulus1", MStimulus.class);
  ...
  private final static Method _slot_setMethod = getMethod1(MLinkObjectImpl.class, "setSlots", Collection.class);
  private final static Method _slot_addMethod = getMethod1(MLinkObjectImpl.class, "addSlot", MAttributeLink.class);
  private final static Method _slot_removeMethod = getMethod1(MLinkObjectImpl.class, "removeSlot", MAttributeLink.class);
  ...
  private final static Method _linkEnd_setMethod = getMethod1(MLinkObjectImpl.class, "setLinkEnds", Collection.class);
  private final static Method _linkEnd_addMethod = getMethod1(MLinkObjectImpl.class, "addLinkEnd", MLinkEnd.class);
  private final static Method _linkEnd_removeMethod = getMethod1(MLinkObjectImpl.class, "removeLinkEnd", MLinkEnd.class);
  ...
  private final static Method _attributeLink_setMethod = getMethod1(MLinkObjectImpl.class, "setAttributeLinks", Collection.class);
  private final static Method _attributeLink_addMethod = getMethod1(MLinkObjectImpl.class, "addAttributeLink", MAttributeLink.class);
  private final static Method _attributeLink_removeMethod = getMethod1(MLinkObjectImpl.class, "removeAttributeLink", MAttributeLink.class);
  ...
  private final static Method _classifier_setMethod = getMethod1(MLinkObjectImpl.class, "setClassifiers", Collection.class);
  private final static Method _classifier_addMethod = getMethod1(MLinkObjectImpl.class, "addClassifier", MClassifier.class);
  private final static Method _classifier_removeMethod = getMethod1(MLinkObjectImpl.class, "removeClassifier", MClassifier.class);

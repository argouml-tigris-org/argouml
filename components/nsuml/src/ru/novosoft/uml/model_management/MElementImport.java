...
public interface MElementImport extends MBase
{
  // generating attributes
  // attribute: alias
  String getAlias();
  void setAlias(String __arg);
  ...
  MPackage getPackage();
  void setPackage(MPackage __arg);
  void internalRefByPackage(MPackage __arg);
  void internalUnrefByPackage(MPackage __arg);
}

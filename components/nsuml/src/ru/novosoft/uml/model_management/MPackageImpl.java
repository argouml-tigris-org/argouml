...
public class MPackageImpl extends MNamespaceImpl implements MPackage
{
  // ------------ code for class GeneralizableElement -----------------
  // generating attributes
  // attribute: isAbstract
  private final static Method _isAbstract_setMethod = getMethod1(MPackageImpl.class, "setAbstract", boolean.class);
  boolean _isAbstract;
  ...
  // attribute: isLeaf
  private final static Method _isLeaf_setMethod = getMethod1(MPackageImpl.class, "setLeaf", boolean.class);
  boolean _isLeaf;
  ...
  // attribute: isRoot
  private final static Method _isRoot_setMethod = getMethod1(MPackageImpl.class, "setRoot", boolean.class);
  boolean _isRoot;
  ...
  private final static Method _specialization_setMethod = getMethod1(MPackageImpl.class, "setSpecializations", Collection.class);
  private final static Method _specialization_addMethod = getMethod1(MPackageImpl.class, "addSpecialization", MGeneralization.class);
  private final static Method _specialization_removeMethod = getMethod1(MPackageImpl.class, "removeSpecialization", MGeneralization.class);
  ...
  private final static Method _generalization_setMethod = getMethod1(MPackageImpl.class, "setGeneralizations", Collection.class);
  private final static Method _generalization_addMethod = getMethod1(MPackageImpl.class, "addGeneralization", MGeneralization.class);
  private final static Method _generalization_removeMethod = getMethod1(MPackageImpl.class, "removeGeneralization", MGeneralization.class);
  ...
  private final static Method _elementImport_setMethod = getMethod1(MPackageImpl.class, "setElementImports", Collection.class);
  private final static Method _elementImport_addMethod = getMethod1(MPackageImpl.class, "addElementImport", MElementImport.class);
  private final static Method _elementImport_removeMethod = getMethod1(MPackageImpl.class, "removeElementImport", MElementImport.class);
  ...
  public final void setElementImports(Collection __arg)
  {
    ...
    try
    {
      ...
      while (iter5.hasNext())
      {
        MElementImport o = (MElementImport)iter5.next();
        o.internalUnrefByPackage(this);
      }
      Iterator iter6 = __added.iterator();
      while (iter6.hasNext())
      {
        MElementImport o = (MElementImport)iter6.next();

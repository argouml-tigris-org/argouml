...
public interface MBehavioralFeature extends MFeature
{
  ...
  // attribute: isQuery
  boolean isQuery();
  void setQuery(boolean __arg);
  // generating associations
  // opposite role: raisedSignal this role: context
  Collection getRaisedSignals();
  void setRaisedSignals(Collection __arg);
  void addRaisedSignal(MSignal __arg);
  void removeRaisedSignal(MSignal __arg);
  void internalRefByRaisedSignal(MSignal __arg);
  void internalUnrefByRaisedSignal(MSignal __arg);

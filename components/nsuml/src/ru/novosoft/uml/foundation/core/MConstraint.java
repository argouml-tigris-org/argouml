...
public interface MConstraint extends MModelElement
{
  ...
  void setConstrainedElement2(MStereotype __arg);
  void internalRefByConstrainedElement2(MStereotype __arg);
  void internalUnrefByConstrainedElement2(MStereotype __arg);

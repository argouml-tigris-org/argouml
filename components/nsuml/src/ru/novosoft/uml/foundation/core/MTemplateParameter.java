...
public interface MTemplateParameter extends MBase
{
  ...
  void setModelElement2(MModelElement __arg);
  void internalRefByModelElement2(MModelElement __arg);
  void internalUnrefByModelElement2(MModelElement __arg);
  // opposite role: defaultElement this role: templateParameter3
  MModelElement getDefaultElement();
  void setDefaultElement(MModelElement __arg);
  void internalRefByDefaultElement(MModelElement __arg);
  void internalUnrefByDefaultElement(MModelElement __arg);
